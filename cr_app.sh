...
--data '{
    ...
    "realm": "/",
    "conditions": ["AMIdentityMembership","AND","AuthLevel","AuthScheme","AuthenticateToRealm","AuthenticateToService","IPv4","IPv6","LDAPFilter","LEAuthLevel","NOT","OAuth2Scope","OR","Policy","ResourceEnvIP","Session","SessionProperty","SimpleTime"],
...
--data '{
    ...
    "resources": ["book/screen","book/screen/button","book/screen/tab"],
